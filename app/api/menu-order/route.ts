...
export async function POST(req: NextRequest) {
  const { customer_name, customer_phone, customer_address, items, subtotal, tax, delivery_fee, delivery_distance_miles, tip, total, special_requests, sms_opted_in, fulfillment_type } = await req.json();
