...
export default function DinnerSuccessPage() {
  ...
  if (status === "error") return <main className="bg-black text-white min-h-screen flex items-center justify-center px-6"><div className="text-center max-w-md"><h1 className="text-3xl font-black mb-4">Something went wrong</h1><p className="text-zinc-400 mb-6">If you were charged, reach out and we'll make it right.</p><a href="/" className="bg-teal-500 text-black font-black px-8 py-4 rounded-full inline-block">Back to Home</a></div></main>;
