  ...
  return (
    <>
        ...
        <div className="flex gap-3">
          ...
          {!isPaid && invoice.stripe_checkout_url && (
            <a
              ...
              className="text-sm font-black bg-teal-500 hover:bg-teal-400 text-black px-6 py-2 rounded-full transition-colors"
            >
      ...
      <div className="min-h-screen bg-zinc-100 py-10 px-4 print:bg-white print:py-0 print:px-0">
        <div className="invoice-shell max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden print:shadow-none print:rounded-none">
          ...
          <div className="bg-zinc-900 px-10 py-8 flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-zinc-400 text-xs mt-2">Issued: {new Date(invoice.created_at).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}</p>
              {invoice.due_date && (
                <p className="text-zinc-400 text-xs">Due: {new Date(invoice.due_date).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}</p>
              )}
          ...
          <div className="px-10 py-8">
            ...
            <div className="flex justify-end mb-8">
              <div className="w-72 space-y-2 text-sm">
                ...
                {isPaid && (
                  <div className="flex justify-between font-black text-teal-600 text-sm pt-1">
            ...
            {/* Notes */}
            {invoice.notes && (
              <div className="bg-zinc-50 rounded-xl p-5 mb-8 border border-zinc-200">
            ...
            {/* Pay Now CTA — hidden on print */}
            {!isPaid && invoice.stripe_checkout_url && (
              <div className="no-print text-center border-t border-zinc-200 pt-8">
                <p className="text-zinc-500 text-sm mb-4">Ready to pay? Click below to complete your payment securely.</p>
                <a
                  href={invoice.stripe_checkout_url}
                  className="inline-block bg-zinc-900 hover:bg-zinc-800 text-white font-black text-lg px-12 py-4 rounded-full transition-colors"
                >
                  Pay {fmt(invoice.total)} — Secure Checkout →
                </a>
                <p className="text-zinc-400 text-xs mt-3">Powered by Stripe. Your card info is never stored on our servers.</p>
              </div>
            )}
          ...
          <div className="border-t border-zinc-200 px-10 py-5 flex items-center justify-between">
            <p className="text-zinc-400 text-xs">Thank you for your business.</p>
